...
// Lấy sort hiện tại: latest | oldest (mặc định latest)
$selected_sort = isset( $_REQUEST['sort'] )
    ? sanitize_text_field( wp_unslash( $_REQUEST['sort'] ) )
    : 'latest';
...
<form class="job_filters">
	...
	<div class="search_jobs">
		...
		<div class="search_location">
            ...
            <label for="job_sort"><?php esc_html_e( 'Sort by', 'jobscout' ); ?></label>
            <select name="sort" id="job_sort">
                <option value="latest" <?php selected( $selected_sort, 'latest' ); ?>>
                    <?php esc_html_e( 'Latest Jobs', 'jobscout' ); ?>
                </option>
                <option value="oldest" <?php selected( $selected_sort, 'oldest' ); ?>>
                    <?php esc_html_e( 'Oldest Jobs', 'jobscout' ); ?>
                </option>
            </select>
        </div>
